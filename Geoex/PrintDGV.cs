...
namespace Geoex
{
    class PrintDGV
    {
        ...
        public static DataGridView dgv;        // Holds DataGridView Object to print its contents
                    ...
                    System.Drawing.Printing.PrintEventArgs e) 
        {
            try
	        {
                ...
                foreach (DataGridViewColumn GridCol in dgv.Columns)
                {
                    ...
                    TotalWidth += GridCol.Width + 8;
                }
                PageNo = 1;
                NewPage = true;
                RowPos = 0;
                PrintDGV.CellHeight = 10;
	        }
	        catch (Exception ex)
	        {
                MessageBox.Show(ex.Message, "Error", MessageBoxButtons.OK, MessageBoxIcon.Error);        		
                    ...
                    System.Drawing.Printing.PrintPageEventArgs e) 
        {
            ...
            int tmpRight = e.MarginBounds.Right;
                        ...
                        
                    {
                        ...
                        if (FitToPageWidth)
                        {
                                ...
                                tmpWidth = (int)(Math.Floor((double)((double)GridCol.Width /
                                           ...
                                           ((double)e.MarginBounds.Width / TotalWidth + .3))));
                ...
                while (RowPos <= dgv.Rows.Count - 1)
                {
                    ...
                    else
                    {
                        if (NewPage)
                        {
                            ...
                            e.Graphics.DrawString(s, new Font("Arial", 8, FontStyle.Regular),
                                    Brushes.Black, e.MarginBounds.Left + (e.MarginBounds.Width -
                                    e.Graphics.MeasureString(s, new Font("Arial", 8,
                                    FontStyle.Regular), e.MarginBounds.Width).Width + 55), e.MarginBounds.Bottom -
                                    e.Graphics.MeasureString(s, new Font(new Font("Arial", 8,
                                    FontStyle.Regular), FontStyle.Regular), e.MarginBounds.Width).Height + 40);

                            ////draw title
                            //e.Graphics.DrawString(PrintTitle, new Font("Arial", 12, FontStyle.Regular), Brushes.Black, e.MarginBounds.Right + (e.MarginBounds.Width -
                            //        e.Graphics.MeasureString(PrintTitle, new Font("Arial", 12,
                            //        FontStyle.Regular), e.MarginBounds.Width).Width), e.MarginBounds.Top -
                            //    e.Graphics.MeasureString(PrintTitle, new Font("Arial", 12, FontStyle.Regular),
                            //    e.MarginBounds.Width).Height + 100);

                            e.Graphics.DrawString("geoex", new Font("Arial Black", 30, FontStyle.Bold),
                                    Brushes.DimGray, e.MarginBounds.Left + (e.MarginBounds.Width -
                                    e.Graphics.MeasureString("geoex", new Font("Arial Black", 30,
                                    FontStyle.Bold), e.MarginBounds.Width).Width + 20), e.MarginBounds.Top -
                                    e.Graphics.MeasureString("geoex", new Font(new Font(dgv.Font,
                                    FontStyle.Bold), FontStyle.Bold), e.MarginBounds.Width).Height - 65);
                            // Draw Columns
